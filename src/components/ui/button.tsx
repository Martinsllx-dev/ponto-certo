  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        transit: "bg-gradient-to-r from-[hsl(199,89%,48%)] to-[hsl(199,89%,38%)] text-primary-foreground shadow-[var(--shadow-button)] hover:opacity-90",
        success: "bg-gradient-to-r from-[hsl(160,84%,39%)] to-[hsl(160,84%,29%)] text-secondary-foreground shadow-[var(--shadow-button)] hover:opacity-90",
        card: "bg-card text-card-foreground shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-elevated)] border border-border/50",
      },
      size: {
